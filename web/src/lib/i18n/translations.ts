...
export interface Translations {
  ...
  alertsPushTab: string;
  alertsPushHeadline: string;
  alertsPushBody: string;
  alertsPushResolvedHeadline: string;
  alertsPushResolvedBody: string;
  alertsPushCta: string;
  alertsPushGetItOn: string;
  mobileAppTag: string;
...
export const TRANSLATIONS: Record<SupportedLocale, Translations> = {
  ...
  en: {
    ...
    alertsPushTab: "Phone Push",
    alertsPushHeadline: "api.myapp.ai is DOWN",
    alertsPushBody: "Connection refused · 3 consecutive failures from ap-southeast-1",
    alertsPushResolvedHeadline: "api.myapp.ai is back UP",
    alertsPushResolvedBody: "Recovered after 2m 14s · 142 ms",
    alertsPushCta: "Install the app and your phone buzzes the moment something breaks — no laptop, no dashboard open.",
    alertsPushGetItOn: "GET IT ON",
    mobileAppTag: "Mobile app",
    mobileAppLink: "Get it on Google Play",
  ...
  zh: {
    ...
    demoChartTitle: "响应时间",
    alertsPushTab: "手机推送",
    alertsPushHeadline: "api.myapp.ai 已宕机",
    alertsPushBody: "连接被拒绝 · 来自 ap-southeast-1 的连续 3 次失败",
    alertsPushResolvedHeadline: "api.myapp.ai 已恢复",
    alertsPushResolvedBody: "中断 2 分 14 秒后恢复 · 142 毫秒",
    alertsPushCta: "安装 App，故障发生的瞬间手机就会震动 —— 无需打开电脑或仪表盘。",
    alertsPushGetItOn: "立即下载",
    mobileAppTag: "移动应用",
    mobileAppLink: "前往 Google Play 下载",
  ...
  ja: {
    ...
    demoChartTitle: "応答時間",
    alertsPushTab: "スマホ通知",
    alertsPushHeadline: "api.myapp.ai がダウン",
    alertsPushBody: "接続拒否 · ap-southeast-1 から3回連続で失敗",
    alertsPushResolvedHeadline: "api.myapp.ai が復旧",
    alertsPushResolvedBody: "2分14秒で復旧 · 142 ms",
    alertsPushCta: "アプリを入れておけば、障害の瞬間にスマホが鳴ります。PCもダッシュボードも不要です。",
    alertsPushGetItOn: "ダウンロード",
    mobileAppTag: "モバイルアプリ",
    mobileAppLink: "Google Play で手に入れよう",
  ...
  ko: {
    ...
    alertsPushTab: "휴대폰 푸시",
    alertsPushHeadline: "api.myapp.ai 장애 발생",
    alertsPushBody: "연결 거부 · ap-southeast-1에서 3회 연속 실패",
    alertsPushResolvedHeadline: "api.myapp.ai 복구됨",
    alertsPushResolvedBody: "2분 14초 만에 복구 · 142 ms",
    alertsPushCta: "앱을 설치하면 장애가 생기는 순간 휴대폰이 울립니다. 노트북도 대시보드도 필요 없습니다.",
    alertsPushGetItOn: "다운로드",
    mobileAppTag: "모바일 앱",
    mobileAppLink: "Google Play에서 받기",
  ...
  ms: {
    ...
    alertsPushTab: "Tolakan Telefon",
    alertsPushHeadline: "api.myapp.ai TIDAK BERFUNGSI",
    alertsPushBody: "Sambungan ditolak · 3 kegagalan berturut dari ap-southeast-1",
    alertsPushResolvedHeadline: "api.myapp.ai kembali NORMAL",
    alertsPushResolvedBody: "Pulih selepas 2m 14s · 142 ms",
    alertsPushCta: "Pasang aplikasi dan telefon anda bergetar sebaik sahaja sesuatu rosak — tanpa komputer riba atau papan pemuka.",
    alertsPushGetItOn: "DAPATKAN DI",
    mobileAppTag: "Aplikasi mudah alih",
    mobileAppLink: "Dapatkan di Google Play",
  ...
  id: {
    ...
    alertsPushTab: "Notifikasi Ponsel",
    alertsPushHeadline: "api.myapp.ai DOWN",
    alertsPushBody: "Koneksi ditolak · 3 kegagalan beruntun dari ap-southeast-1",
    alertsPushResolvedHeadline: "api.myapp.ai kembali UP",
    alertsPushResolvedBody: "Pulih setelah 2m 14s · 142 ms",
    alertsPushCta: "Pasang aplikasinya dan ponsel Anda bergetar begitu ada yang bermasalah — tanpa laptop, tanpa buka dasbor.",
    alertsPushGetItOn: "DAPATKAN DI",
    mobileAppTag: "Aplikasi seluler",
    mobileAppLink: "Dapatkan di Google Play",
  ...
  my: {
    ...
    alertsPushTab: "ဖုန်း အသိပေးချက်",
    alertsPushHeadline: "api.myapp.ai ရပ်တန့်နေသည်",
    alertsPushBody: "ချိတ်ဆက်မှု ငြင်းပယ်ခံရသည် · ap-southeast-1 မှ ၃ ကြိမ်ဆက်တိုက် မအောင်မြင်",
    alertsPushResolvedHeadline: "api.myapp.ai ပြန်လည်ကောင်းမွန်ပြီ",
    alertsPushResolvedBody: "၂ မိနစ် ၁၄ စက္ကန့်အတွင်း ပြန်ကောင်းသည် · 142 ms",
    alertsPushCta: "အက်ပ်ကို ထည့်သွင်းထားပါက ပြဿနာဖြစ်သည်နှင့် ဖုန်းက ချက်ချင်း အသိပေးပါမည် — ကွန်ပျူတာ မလို၊ ဒက်ရှ်ဘုတ် မလိုပါ။",
    alertsPushGetItOn: "ရယူပါ",
    mobileAppTag: "မိုဘိုင်းအက်ပ်",
    mobileAppLink: "Google Play တွင် ရယူပါ",
